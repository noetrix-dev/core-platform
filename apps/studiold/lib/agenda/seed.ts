...
function agendamentosDoDia(dayKey: string): Agendamento[] {
  ...
  return [
    ...
    { id: "ag-05", cliente_id: "cli-15", servico_id: "svc-cb-sobrancelha", inicio: at(750), duracao_minutos: 75, status: "confirmado", origem: "whatsapp", em_atendimento: true, observacoes: "Pediu para deixar a franja mais longa." },
    { id: "ag-06", cliente_id: "cli-02", servico_id: "svc-corte", inicio: at(810), duracao_minutos: 30, status: "confirmado", origem: "whatsapp" },
